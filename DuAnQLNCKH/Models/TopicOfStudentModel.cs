...
namespace DuAnQLNCKH.Models
{
    public class TopicOfStudentModel
    {
        ...
        public bool AddTopicStudent(TopicOfStudent topicOfStudent, string IdTp)
        {
            ...
            com.Parameters.AddWithValue("@Emmail", topicOfStudent.Emmail);
